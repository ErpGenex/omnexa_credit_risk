...
from omnexa_credit_risk.governance import (
...
class TestCreditRiskGovernance(FrappeTestCase):
	def test_submit_policy_and_snapshot(self):
		...
		pols = list_policy_versions("omnexa_credit_risk", policy_name="pricing_policy")
		...
		snaps = list_audit_snapshots("omnexa_credit_risk", process_name="decision_preview", limit=10)
		self.assertTrue(snaps)

		ov = governance_overview("omnexa_credit_risk")
