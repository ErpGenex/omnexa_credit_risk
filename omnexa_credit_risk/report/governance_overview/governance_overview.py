...
def execute(filters=None):
	...
	base = extra or {}
	pol_total = frappe.db.count("Credit Risk Policy Version", base or None)
	pending = frappe.db.count("Credit Risk Policy Version", {**base, "status": "PENDING_APPROVAL"})
	approved = frappe.db.count("Credit Risk Policy Version", {**base, "status": "APPROVED"})
	rejected = frappe.db.count("Credit Risk Policy Version", {**base, "status": "REJECTED"})
	row = {
